...
export default function RegisterPage() {
  ...
  return (
    <div>
      <Header />
      <div className='w-full min-h-[90vh] flex items-center justify-center bg-background'>
        <div className='flex items-center md:min-w-4xl justify-center w-full px-4'>
              ...
              <form onSubmit={handleSubmit(onSubmit)} className='space-y-4'>
                ...
                <div className='space-y-1'>
                  ...
                  <div className='relative'>
                    ...
                    <Input
                      {...register('name')}
                      className={`pl-10 py-5 ${errors.name ? 'border-red-500 focus-visible:ring-red-500' : ''}`}
